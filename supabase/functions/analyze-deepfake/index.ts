  ...
  try {
    ...
    if (isVideo) {
      const result = {
        ...
        decision: "BLOCK",
        confidence: 60,
        label: "Video requires review",
        explanation: "Video analysis is not configured in this demo. Submit for human review.",
        evidence: ["Unsupported media type for the current visual model"],
        needsReview: true,
        reviewReason: "Video model unavailable",
        model: {
          source: "heuristic",
